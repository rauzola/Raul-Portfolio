  ...
  return (
    <div id='about' className={styles.container}>
      ...
      <div className={styles.description}>
        <p>
          Moro em Maringá uma Cidade No interior do Paraná, 
          Mais Também conhecida como a cidade dos universitário, 
          por se uma cidade com um grande numero de estudante na 
          área e tecnologia, sempre busco me aprimorar e me atualizar 
          para ser e oferecer o melhor do meu lado profissional, 
          minhas melhores especialidades são projetar Aplicativo Website 
          e sistemas de médio e pequeno porte, com experiencias em 
          diversos projetos, seguimentos e cliente, de pequenas startups 
          a grandes corporações, Busco fazer meu nome nesse gigantesco 
          mercado de Tecnologia, posso te afirmar você contratando o meu 
