  ...
  return (
    ...
    >
      <div className="flex gap-4 items-start mx-4 md:ml-[10%] md:mr-0 mt-6">
        ...
        // <span className="text-6xl">Meu nome é <span>Raul Sigoli</span></span>
        <span className="text-4xl">Desenvolvedor Fullstack</span> */}
          ...
          >
            {texts.greetings}
            <span className="text-black-blue ml-2 font-bold">Raul Sigoli</span>
          </motion.span>
          <motion.h1
...
>
  <Button
    ...
    data-tooltip-content="Currículo"
